    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('whatsapp', models.CharField(help_text='Указать наличие', max_length=20, verbose_name='WhatsApp')),
                ('telegram', models.CharField(help_text='Указать @ник', max_length=20, verbose_name='Telegram')),
